...
// https://docs.microsoft.com/en-us/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfilterdeletebyid0
//sys	fwpmFilterDeleteById0(engineHandle uintptr, id uint64) (err error) [failretval!=0] = fwpuclnt.FwpmFilterDeleteById0
