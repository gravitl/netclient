...
func init() {
	...
	joinCmd.Flags().BoolP(registerFlags.StaticPort, "i", false, "flag to set host as static port")
	joinCmd.Flags().BoolP(registerFlags.StaticEndpoint, "j", false, "flag to set host as static endpoint")
