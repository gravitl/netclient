...
func init() {
	...
	pushCmd.Flags().BoolP(registerFlags.StaticPort, "i", false, "flag to set host as static port")
	pushCmd.Flags().BoolP(registerFlags.StaticEndpoint, "j", false, "flag to set host as static endpoint")
